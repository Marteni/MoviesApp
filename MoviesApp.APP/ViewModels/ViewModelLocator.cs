...
namespace MoviesApp.APP.ViewModels
{
    public class ViewModelLocator
    {
        ...
        public static MovieDetailViewModel MovieDetailViewModel { get; } = new MovieDetailViewModel(_peopleRepository, _actorRepository,_movieRepository);
        ...
        public static PersonDetailViewModel PersonDetailViewModel { get; } = new PersonDetailViewModel(_movieRepository,_actorRepository);
    }
}
